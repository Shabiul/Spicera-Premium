    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in">
          <h2 className="font-display text-4xl md:text-5xl font-bold text-spice-brown mb-4">Customer Stories</h2>
          <p className="text-xl text-gray-600">Hear from our satisfied customers</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-spice-cream p-8 rounded-2xl fade-in">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-spice-gold rounded-full flex items-center justify-center mr-4">
                  <span className="font-semibold text-spice-dark">{testimonial.initials}</span>
                </div>
                <div>
                  <h4 className="font-semibold text-spice-brown">{testimonial.name}</h4>
