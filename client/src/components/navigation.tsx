        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link to="/store" className="text-white hover:text-spice-gold transition-all duration-300 font-medium relative group">
                Store
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-spice-gold transition-all duration-300 group-hover:w-full"></span>
              </Link>
              ...
              <Link to="/cart" className="relative p-2 text-white hover:text-spice-gold transition-colors duration-300">
                <ShoppingCart className="w-6 h-6" />
                {cartItemCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-spice-gold text-black text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                    {cartItemCount}
                  </span>
                )}
              </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 glass-dark rounded-b-lg mx-4">
              ...
              <Link to="/store" className="block px-3 py-2 text-white hover:text-spice-gold transition-colors font-medium">Store</Link>
              ...
              <Link to="/cart" className="flex items-center justify-between px-3 py-2 text-white hover:text-spice-gold transition-colors font-medium">
                <span className="flex items-center">
                  <ShoppingCart className="w-4 h-4 mr-2" />
                  Cart
                </span>
                {cartItemCount > 0 && (
                  <span className="bg-spice-gold text-black text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                    {cartItemCount}
                  </span>
                )}
              </Link>
